...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: в одном документе может быть больше одного вхождения.
```
...
```
# 3.4 Ответ: в лексико-грамматическом поиске нельзя искать словосочетания., только слова или словоформы
```
